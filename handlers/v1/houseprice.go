...
var housepriceModel *photo.Houseprice

func HousepriceList(c *gin.Context) {
	baseParamsStruct := model.BaseParams{}
	baseParamsMaps := map[string]interface{}{}
	listParamsStruct := photo.HousepriceListParams{}
	...
	data, pagin, notFound := housepriceModel.List(baseParamsMaps, listParamsMaps)
	if notFound {
